    ...
    internal sealed class Emitter
    {
        ...
        private Emitter(string moduleName, string[] references)
        {
            ...
            TypeReference ResolveType(string trilliumName, string metadataName)
            {
                ...
                {
                    _diagnostics.ReportRequiredTypeNotFound(trilliumName, metadataName);
                }
                else
                {
                    _diagnostics.ReportRequiredTypeAmbiguous(trilliumName, metadataName, foundTypes);
                }
